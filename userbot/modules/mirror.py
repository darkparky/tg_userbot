...
def drive_auth():
    ...
    if gauth.credentials is None:
        raise "NoSecret: Failed to authenticate with Google Drive"
...
CMD_HELP.update({
    "mirror":
        "Download a file from telegram or link to "
        "the server then upload to your GDrive. \n"
        "Usage: `.mirror [in reply to TG file]` "
